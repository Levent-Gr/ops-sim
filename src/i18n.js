...
export const I18N = {
  tr: {
    ...
    nav_sim: 'Hesaplama', nav_delivery: 'Teslimat Yönetimi', nav_history: 'Geçmiş', nav_stats: 'İstatistik', nav_groups: 'Gruplar', nav_settings: 'Ayarlar',
    ...
    stats_title: 'İstatistik', stats_overview: 'Genel Doğruluk', stats_count: 'Analiz edilen teslimat',
  ...
  en: {
    ...
    nav_sim: 'Simulation', nav_delivery: 'Delivery Manager', nav_history: 'History', nav_stats: 'Statistics', nav_groups: 'Groups', nav_settings: 'Settings',
    ...
    stats_title: 'Statistics', stats_overview: 'Overall Accuracy', stats_count: 'Deliveries analyzed',
